...
namespace VideoClub.Windows.Helper
{
    public class HelperGrilla
    {
        ...
        public static void SetearFila(DataGridViewRow r, object obj)
        {
            ...
            {
                case Pelicula p:
                    r.Cells[0].Value = ((Pelicula)obj).Titulo;
                    r.Cells[1].Value = ((Pelicula)obj).Genero.Descripcion;
                    r.Cells[2].Value = ((Pelicula)obj).FechaIncorporacion;
                    ...
                    r.Cells[6].Value = ((Pelicula)obj).Alquilado;
                    r.Cells[7].Value = ((Pelicula)obj).Activa;
                    break;
