    ...
    public partial class frmPeliculasAE : Form
    {
        ...
        protected override void OnLoad(EventArgs e)
        {
            ...
            if (pelicula != null)
            {
                ...
                GenerosComboBox.SelectedValue = pelicula.Genero.GeneroId;
                FechaDateTimePicker.Value = pelicula.FechaIncorporacion;
                EstadosComboBox.SelectedValue = pelicula.Estado.EstadoId;
                CalificacionesComboBox.SelectedValue = pelicula.Calificacion.CalificacionId;
                pelicula.DuracionEnMinutos = int.Parse(DuracionTextBox.Text);
                SoportesComboBox.SelectedValue = pelicula.Soporte.SoporteId;
